...
; =====================================================================================
; AHK Version ...: AHK 1.1.32.00 (Unicode 64-bit) - July 7th, 2020
; Platform ......: Windows 10
...
/*
Makes		WEBSITE	USERNAME	PASSWORD	
Porsche		https://www.dealer-site.com/admin/build_sheets/print.php?vin=WP0AD2A99BS766849			
Chrysler/Jeep/Dodge/Ram		https://www.chrysler.com/hostd/windowsticker/getWindowStickerPdf.do?vin=2C3CCABT4GH220298			
Kia		https://www.kia.com/us/en/data/dealerinventory/windowsticker/5XYPHDA52GG080656			
Audi		http://windowsticker-prod.aws.manheim.com/windowsticker/WAUF2AFC8GN016923/4905414?lang=en_US			
Mitsubishi		https://www.mitsubishicars.com/rs/file/monroney?vin=JA32W8FVXEU012194			
VOLKSWAGEN		http://windowsticker-prod.aws.manheim.com/windowsticker/WAUF2AFC8GN016923/4905414?lang=en_US			
Toyota		https://www.toyota.com/owners/my-vehicle/vehicle-specification			
Ford/Lincoln		http://www.vlplus.dealerconnection.com	l-eury9	Fortmill1234%	
Hyundai		https://webdcs.hyundaidealer.com/irj/portal/iam	Dealer code: AL015	username: DLR011083602	password: Carsused47!
Mercedes Benz		https://netstar5.mbusa.i.daimler.com/netstar/portal/	D7LEEURY	Sonic111***	
Nissan/Infiniti		https://www.nnanet.com/wps/myportal/!ut/p/c1/04_SB8K8xLLM9MSSzPy8xBz9CP0os3gfg2ADA4tgQzMPNxdTAyM_E2OL0BALYwN3Q6B8JG55A1MCusNB9uHXD5I3wAEcDfT9PPJzU_ULciMMskwcFQGSJWJc/dl2/d1/L2dJQSEvUUt3QS9ZQnB3LzZfTDBTMDA4UzE2SEZENTAyTjQzOFVUODMwMDc!/	XD657558	%8N4I!1a25F6	
Buick/Cadillac/GMC/Chev		https://www.autopartners.net/gmentsso/UI/Login?goto=https%3A%2F%2Fdealer.autopartners.net%3A443%2Fportal%2Fus%2FPages%2Fdefault.aspx&gx_charset=UTF-8	CBonham1	Cameron12	 
				 	
Hyundai 2nd source		https://www.vandergriffhyundai.com/api/legacy/pse/windowsticker/hyundai?vin=KM8J3CA46JU775925		 	
					
					
2nd Source CDJR		https://www.dodge.com/webselfservice/BuildSheetServlet?vin=1C3CCCCG5FN524646			
LEXUS		https://www.google.com/url?q=https://drivers.lexus.com/lexusdrivers/resources/viewSpecifications?redirect_uri%3D/lexusdrivers/resources/vehicle-specs%23/collapseTwo&sa=D&source=hangouts&ust=1595079087399000&usg=AFQjCNGklQiMQ_ziTy1mbHD4_xJR10Mimg			
...
class caseMenu {
    __new(){
        ...
        for _, j in [["VINAnalysis","Search &VIN","2"],["carfaxSearch","Search CarFax","26"],["jiraFunc","Search &JIRA","6"],["carGurus","Search Car&Gurus","1"],["searchHubspot","Search &Hubspot","5"],["searchCompanyContacts","Search Dealer Contacts","5"]]
        ...
        for _, j in [["searchVXDealer","Search V&XDealer","25"]]
...
caseChange(text,type){ ; type: U=UPPER, L=Lower, T=Title, S=Sentence, I=Invert
    static X:= ["iOS","iPhone","iPad","I","AHK","AutoHotkey","Dr","Mr","Ms","Mrs","BK","DEA","AKJ","via","v","vs","GPG","PGP","to","of","and","on","with","USB","VIN", "RAV4", "XV", "GMC", "RX" ]
...
ChryslerBook(){
    ...
    openLink := "https://www.chrysler.com/hostd/windowsticker/getWindowStickerPdf.do?vin=" . searchTerm 
...
;~ https://www.vl.dealerconnection.com/Common/Server/Utility/Actual_WindowSticker_loading_msg.asp?vin=
...
FordBook(){
    ...
    openLink := "https://www.vl.dealerconnection.com/Common/Server/Utility/Actual_WindowSticker_loading_msg.asp?vin=" . searchTerm 
    toast("Searching VIN Analysis", searchTerm, ,2000)
    shellrun(openLink)
    Clipboard := searchTerm
    return
...
searchVXDealer(){
    searchTerm := searchTermClean()
        ...
        if (searchTerm = "") {
            toast("Clipboard Empty/No Match Found", "`nHighlight a Dealer Name", ,5000)
            return
        }
